...
self.addEventListener("activate", event => {
  event.waitUntil((async () => {
    // Alte SABBEL-App-Caches entfernen.
    // Badge-Cache bleibt ausdrücklich erhalten.
...
self.addEventListener("push", event => {
  event.waitUntil((async () => {
     ...
     * alles andere = normale Textnachricht
     */
    const isVoice =
      message.notification_type === "voice";

    /*
     * Bei einer Sprachnachricht wird der eigentliche
     * Nachrichteninhalt NICHT angezeigt.
     */
    const body = isVoice
      ? "Sprachnachricht"
      : (
    ...
    /*
     * Großes Symbol rechts:
     *
     * Textnachricht  -> gelber Brief
     * Sprachnachricht -> rotes Original-Megafon
     */
    ...
    await self.registration
      .showNotification(
        sender + " hat dich angesabbelt:",
        {
          ...
          /*
           * WICHTIG:
           * Dieses kleine Android-Statusleisten-Symbol
           * bleibt UNVERÄNDERT.
           */
          badge: new URL(
            "badge-192.png",
